...
export const help: Record<string, HelpEntry> = {
  ...
  "profile.width": {
    ...
    url: `${DOCS_BASE}/guide/configuration/#render-profiles-section`,
  },
  "profile.height": {
  ...
  "profile.crop_mode": {
    ...
    url: `${DOCS_BASE}/cli/render/#crop-modes`,
  },
  "profile.pad_color": {
  ...
  "profile.speed_segments": {
    ...
    url: `${DOCS_BASE}/cli/render/#variable-speed-segments`,
  },
  "profile.lut": {
  ...
  "profile.codec": {
    ...
    url: `${DOCS_BASE}/cli/render/#encoding-settings`,
  },
  "profile.preset": {
  ...
  "render.mode": {
    ...
    url: `${DOCS_BASE}/cli/render/#commands`,
  },
  ...
  "plugins.enforce_hooks": {
    ...
    url: `${DOCS_BASE}/cli/plugins/#plugin-extension-points`,
  },
  ...
  "events.types": {
    ...
    url: `${DOCS_BASE}/examples/04-segments-and-events/`,
  },
  ...
  "config.source_dir": {
    ...
    url: `${DOCS_BASE}/guide/configuration/#paths-section`,
  },
  "config.output_dir": {
